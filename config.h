...
extern const unsigned TASK[]; // TASK[p] is the task executing on the processor p
extern const unsigned OFFSET[]; // OFFSET[j] is the processor offset for task j
// extern const unsigned BANKLATENCY;
// extern const unsigned DELTAS[8][8];
